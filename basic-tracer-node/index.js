 ...
 * `opentelemetry.trace.getTracer`, they will use this tracer provider.
 * If you do not register a global tracer provider, instrumentation which calls these
...
function doWork(parent) {
  ...
  // Anotate our span to capture metadata about our operation
  span.addEvent('invoking do work');
